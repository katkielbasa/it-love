    ...
    <body>
        ...
        <form:form modelAttribute="entry">
            ...
            <table border="1">
                ...
                <tr>
                    <td><spring:message code="carMarka.label" /></td>
                    <td>
                ...
                <tr>
                    <td><spring:message code="carKolor.label" /></td>
                    <td>
                ...
                <tr>
                    <td><spring:message code="computerNazwa.label" /></td>
                    <td>
                        <form:input path="computer.nazwa" />
                        <form:errors path="computer.nazwa" />
                    </td>
                </tr>
                <tr>
                    <td><spring:message code="computerOpis.label" /></td>
                    <td>
                        <form:input path="computer.opis" />
                        <form:errors path="computer.opis" />
                    </td>
                </tr>
